...
If you are the first time in Hamburg we have some tipps for getting around here and what you should probably visit while being here. Having some days left before or after Ruby Unconf? [Hamburg is beautiful <3]({{site.baseurl}}{% link hamburg.md %}#sightseeing)
</div>
...
![Family Photo](assets/images/family_photo.jpg)
</div>
